  ...
  return (
    <div>
      ...
      <div className="bg-slate-900">
        <div>
        <p className='font-medium flex text-[#F7FAFF] justify-center text-2xl sm:text-3xl lg:text-5xl'><p className='mt-12 mb-12'>Resources Vault</p></p>
        ...
        <div className="mb-10  mr-12 ml-12 gap-12 pr-12 pl-12 flex flex-row  ">
          <div className="mb-5 ml-12 mt-8 shadow-2xl bg-[#312e81] rounded border-2 border-sky-500 transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-110  duration-300   ">
